...
namespace Unity.Burst.Editor
{
    internal class BurstInspectorGUI : EditorWindow
    {
        ...
        public void OnEnable()
        {
            ...
            Task.Run(
                ...
                .ContinueWith(t =>
                {
                    ...
                    {
                        // TODO: Should we be catching this state perhaps?
                    }
                });
        }
        ...
        private void HandleButtonBars(BurstCompileTarget target, bool targetChanged, out int fontIndex, out bool collapse, out bool focusCode)
        {
            ...
            RenderButtonBars((position.width * 2) / 3 - _scrollbarThickness, target, out fontIndex, out collapse, out focusCode);
        ...
        private void RenderButtonBars(float width, BurstCompileTarget target, out int fontIndex, out bool collapse, out bool focus)
        {
            ...
            var contentDisasmKin = new GUIContent("");
            ...
            _assemblyKind = (AssemblyOptions)EditorGUILayout.EnumPopup(contentDisasmKin, _assemblyKind, DisplayAssemblyKind, true);
            ...
            // Want to avoid the toggle expanding it's click-area beyond text, when given its own line (only needed for last menu item).
            ...
            _showBranchMarkers = GUILayout.Toggle(_showBranchMarkers, contentBranchLines, EditorStyles.toggle, GUILayout.Width(contentBranchLinesSize));
